...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class TapToPlace : MonoBehaviour, IInputClickHandler
    {
        ...
        internal string originAnchorName = "originAnchor";

        public EventHandler OnPlaced;
        ...
        private void StopPlacing()
        {
            ...
            //ToggleSpatialMesh();
            Debug.Log("I reached Stop Placing [TapToPlace]!");
            AttachWorldAnchor();
            OnPlaced(this, null);
        }
        ...
        {
            Debug.Log("I reached Attach World Anchor! [TapToPlace]");

            if (WorldAnchorManager.Instance != null)
            {
                // Add world anchor when object placement is done.
                WorldAnchorManager.Instance.AttachAnchor(PlaceParentOnTap ? ParentGameObjectToPlace : gameObject, originAnchorName);
                Debug.Log("[TapToPlace] " +
                    "Anchor Attached with anchor name: " + originAnchorName);
            }
        }
        ...
        private void RemoveWorldAnchor()
        {
            if (WorldAnchorManager.Instance != null)
            {
                Debug.Log("Removing world anchor [TapToPlace]");
